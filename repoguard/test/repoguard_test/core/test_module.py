# pylint: disable=E1101,E0611,F0401,W0212,C0103,R0201,R0903,W0232,W0201
# E1101,E0611,F0401: Pylint cannot import py.test
# C0103: Arguments __, ___ are used to indacte not used argument parameter.
#        They are used in mock functions so this is fine.
# R0201: Cannot make test methods static as nose would not find them anymore. 
# R0903,W0232: General problem with configuration definition of handler/checks.
# W0201: Just to simplify testing in TestConfigSerializer.test_to_config
#
...
class TestConfigSerializer(object):
    ...
    def test_from_config(self):
        """ Tests conversion of a configuration dictionary into a 
...
class TestCheckCache(object):
    ...
    def setup_class(cls):
        ...
        cls.buildin_modules = {"PyLint": None, "Mantis": None, 
                               "AccessRights": None, "ASCIIEncoded": None,
                               "CaseInsensitiveFilenameClash": None, 
                               "Checkout": None, "Checkstyle": None,
                               "Keywords": None, "Log": None, 
                               "RejectTabs": None, "UnitTests": None, 
                               "XMLValidator": None}
...
class TestHandlerCache(object):
    ...
    def setup_class(cls):
        ...
        cls._process = ProjectConfig(_CONFIG_STRING, "hooks").profiles[0].\
                       get_process(constants.PRECOMMIT)
