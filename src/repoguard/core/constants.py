...
CONFIG_HOME = "."
BUILDIN_TPL_PATH = os.path.join(CONFIG_HOME, "cfg", "templates")
...
CONFIG_PATH = os.path.join(CONFIG_HOME, "cfg", CONFIG_FILENAME)
LOGGER_PATH = os.path.join(CONFIG_HOME, "cfg", LOGGER_FILENAME)
